...
/**
 * @namespace CameraStateFile types
 *
 */
namespace CameraStateFile {

  /**
   * @brief Object for interacting with CameraStateFile target configs
   * 
  ...
  class Config {
    public:
       ...
       * 
       * The global JSON object represents the current CameraStateFile 
