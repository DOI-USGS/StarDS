...
namespace CameraStateFile {
  ...
  **/
   ...
   * 
   * Default behavior returns the installed DB files in $CONDA_PREFIX/etc/CameraStateFile/db.
   *
   * If the env var $SPICEQL_DEV_DB is set, this returns the local source path of 
   * _SOURCE_PREFIX/CameraStateFile/db/ 
   * 
   ...
   **/
    ...
    *
    * @returns CameraStateFile's REST URL as string
   **/
